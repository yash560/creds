    ...
    <>
      <div className="form-group" style={{ marginBottom: 0 }}>
        ...
        <select
          className="form-select"
          value={
            DOC_CATEGORIES.includes(fields.category) ? fields.category : (fields.category ? "Other" : "")
          }
      ...
      {(fields.category === "Other" || (fields.category && !DOC_CATEGORIES.includes(fields.category))) && (
        <div className="form-group animate-slideDown" style={{ marginBottom: 0 }}>
          <label className="form-label">Custom Category</label>
          <input
            className="form-input"
            value={fields.category === "Other" ? "" : fields.category}
            onChange={(e) => setField("category", e.target.value || "Other")}
